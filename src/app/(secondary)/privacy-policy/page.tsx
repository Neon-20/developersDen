			...
			<Card className="max-w-prose mx-auto">
				<CardHeader>
					...
					<CardDescription>
						...
						<br />
						<br />
						{`This Privacy Policy describes how developersDen ("we", "us", or "our")
						...
						>
							https://developersDen.pranavrajveer.com
						</Link>{" "}
						{`(the "Website").`}
					</CardDescription>
				</CardHeader>
				<CardContent>
					<div className="space-y-6">
						<div>
							...
							<p>
								When you use developersDen, we may collect the following
								information:
							</p>
