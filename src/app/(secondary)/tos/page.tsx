			...
			<Card className="max-w-prose mx-auto">
				<CardHeader>
					...
					<CardDescription>
						...
						<br />
						<br />
						{`By accessing or using developersDen (the "Website"), you agree to be
				...
				<CardContent>
					<div className="space-y-6">
						<div>
							...
							<p>
							developersDen is an open-source collection of Web Development &
						...
						<div>
							...
							<p>
								When you use DevelopersDen, we may collect your name and email
								address. We are committed to protecting your privacy, and our
								use of your personal information is governed by our{" "}
								<a
									href="https://developersDen.pranavrajveer.com/privacy-policy"
						...
						<p>
							...
							<a
								...
								className="text-blue-500 hover:underline"
							>
								pranavrajveer.workmail@gmail.com
							</a>
							.
						</p>

						<p>Thank you for using DevelopersDen!</p>
					</div>
				</CardContent>
			</Card>
		</div>
